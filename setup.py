...
setup(
    ...
    description="DACHS (Database for Automation and Consistent Holistic Synthesis) is a structure to document automated syntheses",
    long_description=readme,
    author="Brian R. Pauw",
    author_email="brian.pauw@bam.de",
    url="https://github.com/bamresearch/dachs",
